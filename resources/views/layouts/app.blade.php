...
<head>
    ...
    @stack('page_css') --}}
    <!-- plugin css -->
    <link href="{{ asset('dist/lineone/css/jquery-jvectormap-1.2.2.css') }}" rel="stylesheet" type="text/css" />

    <!-- preloader css -->
    <link rel="stylesheet" href="{{ asset('dist/lineone/css/preloader.min.css') }}" type="text/css" />
